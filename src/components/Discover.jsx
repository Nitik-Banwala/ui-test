...
const Discover = () => {
  return (
    <div className=' px-4 mt-42.5 mb-25 '>
      <div className="sm:h-[328.1px] h-auto flex flex-col  items-center max-w-285 mx-auto rounded-3xl pt-15 pb-15.5 bg-[url('/assets/images/Bg-img2.png')] bg-cover bg-center ">
